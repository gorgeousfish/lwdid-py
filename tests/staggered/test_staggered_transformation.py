...
class TestTransformationStataConsistency:
    ...
    @pytest.fixture
    def staggered_data_with_transforms(self, staggered_data):
        """计算变换变量并添加到数据"""
    ...
    def test_transformation_consistency_44(self, staggered_data):
    ...
    def test_transformation_consistency_55(self, staggered_data):
    ...
    def test_transformation_consistency_66(self, staggered_data):
    ...
    def test_all_transformations_vs_stata_logic(self, staggered_data, g, r):
...
class TestTransformationBoundaryConditions:
    ...
    def test_multiple_units_transformation(self, staggered_data):
        """测试多单位变换的正确性"""
        # 验证每个单位都正确计算了变换
        y_44 = compute_transformed_outcome(staggered_data, 'y', 'id', 'year', 4, 4)
    ...
    def test_transformation_preserves_unit_identity(self, staggered_data):
        """测试变换保持单位标识"""
        y_44 = compute_transformed_outcome(staggered_data, 'y', 'id', 'year', 4, 4)
        
        # 变换结果的index应该是单位ID
        expected_ids = set(staggered_data['id'].unique())
...
class TestStataLagEquivalence:
    ...
    def test_lag_interpretation_44(self, staggered_data):
        """测试(4,4)的lag解释正确"""
    ...
    def test_lag_interpretation_45(self, staggered_data):
        """测试(4,5)的lag解释正确"""
